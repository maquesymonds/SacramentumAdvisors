...
export default function OlasBackground({ initialTop }: { initialTop: number }) {
  ...
  // Move image live as slider changes
  useEffect(() => {
    if (imgRef.current) imgRef.current.style.top = `${top}px`;
  }, [top]);
  ...
  const save = async () => {
    ...
    try {
      ...
      await fetch("/api/admin/content", {
        ...
        body:    JSON.stringify({ ...data, olasTop: top }),
      });
      setSaved(true);
          ...
          {open && (
            <div style={{ padding: "1rem" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.75rem" }}>
                ...
                <span style={{ color: "#CCA87C", fontWeight: 700, fontSize: "0.9rem" }}>{top}px</span>
              </div>
              ...
              <input
                ...
                style={{ width: "100%", accentColor: "#CCA87C", cursor: "pointer", marginBottom: "1rem" }}
              />
