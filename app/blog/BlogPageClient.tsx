...
function BlogCard({ post, readLabel, locale }: { post: BlogPost; readLabel: string; locale: "en" | "es" }) {
  return (
...
function MobileBlogCard({ post, readLabel, locale }: { post: BlogPost; readLabel: string; locale: "en" | "es" }) {
  return (
